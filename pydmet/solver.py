...
class SolverMixin(object):
    ...
    def kernel(self, emb_prob):
        raise NotImplementedError

    def solve_mf(self, emb_prob):
        norb   = emb_prob.neo
...
class RCCSD(SolverMixin):
    ...
    def kernel(self, emb_prob):
        mf, dn_dmu = self.solve_mf(emb_prob)
